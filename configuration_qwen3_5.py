...
class Qwen3_5Config(PreTrainedConfig):
    ...
    pose_feature_dim: int = 1659  # 33*3 + 478*3 + 21*3 + 21*3 (pose + face + left_hand + right_hand)
    # pose_feature_dim: int = 798 # 2*133*3 (2 people * num_keypoints * (xy+scores))
    pose_sample_n: int = 16       # frames to sample per video for pose extraction
